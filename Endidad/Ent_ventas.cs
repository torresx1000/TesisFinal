...
namespace Endidad
{
    public class Ent_ventas
    {
        public int idVenta{ get; set; }           // Identificador de compra
        public DateTime fecha { get; set; }         // Fecha de la venta
        public string motivo { get; set; }          // Motivo de la venta
        ...
        public decimal mont_tt { get; set; }        // Monto total de la venta
