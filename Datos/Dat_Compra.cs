...
namespace Datos
{
    public class Dat_Compra
    {
        #region Singleton
        private static readonly Dat_Compra _instancia = new Dat_Compra();
        public static Dat_Compra Instancia
        {
            get
            {
                return Dat_Compra._instancia;
            }
        }
        #endregion Singleton

        // Listar compras
        public List<Ent_compra> ListarCompras()
        {
            SqlCommand cmd = null;
            List<Ent_compra> lista = new List<Ent_compra>();
            try
            {
                ...
                while (dr.Read())
                {
                    Ent_compra compra = new Ent_compra();
        ...
        // Insertar compra
        public Boolean InsertarCompra(Ent_compra compra)
        {
            SqlCommand cmd = null;
        ...
        public Boolean ModificarCompra(Ent_compra compra)
        {
            SqlCommand cmd = null;
            Boolean edita = false;
            try
        ...
        public Boolean EliminarCompra(Ent_compra compra)
        {
            SqlCommand cmd = null;
